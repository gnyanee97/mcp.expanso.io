...
export function getVulcanConfig(tenantConfig: TenantConfig | null): VulcanConfig {
  ...
  // api_key uses Bearer Authorization header format (matches Postman working format)
  ...
  // If api_key is provided, use Bearer scheme; otherwise use configured scheme
